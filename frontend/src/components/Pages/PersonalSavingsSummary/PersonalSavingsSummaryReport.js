...
const PersonalSavingsSummaryReport = ({
  ...
  const handlePrint = () => {
    ...
    let htmlContent = `
      ...
      <html>
        <head>
          <title>Personal Savings Summary - Print Preview</title>
          <meta charset="utf-8">
          <style>
            @page {
              size: A4 landscape;
      ...
      if (pageIndex === 0) {
        htmlContent += `
          ...
          <div class="print-subheading-box">
            <h2 class="print-sub-heading">Personal Savings Summary for ${branchName}${
      ...
      <div className="psss-report-table-section psss-screen-only">
        <table className="psss-report-table">
          <thead>
            <tr>
              <th>Product Name</th>
              <th className="psss-right-align">Number of Accounts</th>
              <th className="psss-right-align">Interest Policy</th>
              <th className="psss-right-align">Total Balance</th>
              <th className="psss-right-align">Min Interest Rate</th>
              <th>Branch Name</th>
              <th className="psss-right-align">Max Interest Rate</th>
            </tr>
          </thead>
          <tbody>
